...
export const ORACLE_PROGRAM_ID = "BkdrrqR4RrCB6m5YhMmWtjHpzuFPhdrvoA9x2tPFsWfj";
export const MINTER_PROGRAM_ID = "DJpBzQRWtuhnqFpjS9xVELb29wCkRNVeT7ZKnq8uHEyp";
